...
from inv_oper_error import InvalidOperationError
...
class Game:
    ...
    def generate_word(self) -> str:
        filename = 'C:\\Users\\nn\\Python Уроки\\8. Движемся дальше\\DZ\\hangman\\data\\WordsStockRus.txt'
    ...
    def guess_letter(self, letter: str) -> Iterable[str]:
        ...
        self.__tries_letters.append(letter)
    ...
    @property
    def tries_letters(self) -> Iterable[str]:
        return sorted(self.__tries_letters)
